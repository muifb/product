...
<body>
    ...
    <aside class="sidebar">
        ...
        <a class="sidebar-item produksi <?= $data['judul'] == 'Data Product' ? 'active' : ''; ?>" href="/product">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="sidebar-item output <?= $data['judul'] == 'Data Output Product' ? 'active' : ''; ?>" href="/output">
        ...
        <a class="sidebar-item <?= $data['judul'] == 'Lost Time Product' ? 'active' : ''; ?>" href="/lost">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(171, 179, 196, 1);">
        ...
        <a class="sidebar-item <?= $data['judul'] == 'Data Product OK' ? 'active' : ''; ?>" href="/ok">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(171, 179, 196, 1);">
        ...
        <a class="sidebar-item <?= $data['judul'] == 'Data Product NC' ? 'active' : ''; ?>" href="/nc">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(171, 179, 196, 1);">
        ...
        <a class="sidebar-item reject <?= $data['judul'] == 'Data Product Reject' ? 'active' : ''; ?>" href="/reject">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(171, 179, 196, 1);">
        ...
        <a class="sidebar-item reject <?= $data['judul'] == 'Data OEE' ? 'active' : ''; ?>" href="/Oee">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(171, 179, 196, 1);">
                <path d="M3 20c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2h-2a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1H5c-1.103 0-2 .897-2 2v15zM5 5h2v2h10V5h2v15H5V5z"></path>
                <path d="M14.292 10.295 12 12.587l-2.292-2.292-1.414 1.414 2.292 2.292-2.292 2.292 1.414 1.414L12 15.415l2.292 2.292 1.414-1.414-2.292-2.292 2.292-2.292z"></path>
            </svg>
    ...
    <main class="mian" id="main">
        <nav class="nav no-print">
            ...
            <div class="d-flex justify-content-between align-items-center nav-input-container">
                <button class="btn-notif d-none d-md-block" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Profile" onclick="document.location='/user'"><img src="<?= BASEURL; ?>/assets/img/global/profile.svg" alt=""></button>
            </div>
        </nav>
