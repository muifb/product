function Tour(steps, options) {
  ...
  var getPopoverSettings = function (arrows) {
    var template =
      '<div id="tour" class="popover popover-tour" role="tooltip">' +
      '<div class="popover-arrow"></div>';
    if (!arrows) {
      template =
        '<div id="tour" class="popover popover-tour popover-tour-center" role="tooltip">';
    }
...
Tour.prototype.show = function () {
  ...
  var opt = {};
  opt = this.extend(
    this.getDefaultPopoverSettings(),
  ...
  var tabLinks = popover.tip
    .getElementsByClassName("tour-tab-links")[0]
